...
//var allvalue=document.querySelectorAll("first","second","third","fourth","fifth")
var firstvalue=document.getElementById("first")
var secondvalue=document.getElementById("second")
var thirdvalue=document.getElementById("third")
var fourthvalue=document.getElementById("four")
var fifthvalue=document.getElementById("five")
var previous=document.getElementById("prev")
var last= document.getElementById("last")
var tablebody=document.getElementById("oldbody")
...
cell1.innerHTML=myArray[i].id;
row.appendChild(cell1)
var cell2=document.createElement("td");
cell2.innerHTML=myArray[i].name;
row.appendChild(cell2)
var cell3=document.createElement("td");
cell3.innerHTML=myArray[i].email;
...
var previous= function(){
  var firstval=document.getElementById("first").innerHTML
  if(firstval>5)
  {
    document.getElementById("five").innerHTML=(+firstval)-1
    document.getElementById("four").innerHTML=(+firstval)-2
    document.getElementById("third").innerHTML=(+firstval)-3
    document.getElementById("second").innerHTML=(+firstval)-4
    document.getElementById("first").innerHTML=(+firstval)-5
  }

  }
  var last=function(){
    var lastval=document.getElementById("five").innerHTML
    if(lastval<16)
    {
      document.getElementById("first").innerHTML=(+lastval)+1
      document.getElementById("second").innerHTML=(+lastval)+2
      document.getElementById("third").innerHTML=(+lastval)+3
      document.getElementById("four").innerHTML=(+lastval)+4
      document.getElementById("five").innerHTML=(+lastval)+5
    }
  
    }

  // var fisrtclick=function(){
  //   var element = document.getElementById("first");
  //   element.classList.remove("");
  // }  
firstvalue.addEventListener('click',changestyle);
secondvalue.addEventListener('click',changestyle);
thirdvalue.addEventListener('click',changestyle);
fourthvalue.addEventListener('click',changestyle);
fifthvalue.addEventListener('click',changestyle);

  function changestyle(){
  if(this.id==="first"){

var firstitem=document.getElementById("first").innerHTML
var table=document.createElement("table");
var newbody=document.createElement("tbody")
newbody.setAttribute("id","newvalue")
for(var i=(((+firstitem)-1)*5);i<=(((+firstitem)-1)*5)+4;i++)
{
...
newbody.appendChild(row);
  ...
  {
    var firstitem=document.getElementById("second").innerHTML
var table=document.createElement("table");
var newbody=document.createElement("tbody")
newbody.setAttribute("id","newvalue")
for(var i=(((+firstitem)-1)*5);i<=(((+firstitem)-1)*5)+4;i++)
...
newbody.appendChild(row);
  ...
  newbody.parentNode.replaceChild(oldbody,newbody)
    ...
    document.getElementById("second").style.backgroundColor="dodgerblue"
  ...
  {
    var firstitem=document.getElementById("third").innerHTML
    var table=document.createElement("table");
    var newbody=document.createElement("tbody")
    newbody.setAttribute("id","newvalue")
    for(var i=(((+firstitem)-1)*5);i<=(((+firstitem)-1)*5)+4;i++)
    ...
    document.getElementById("second").style.backgroundColor="transparent"
    document.getElementById("second").style.color="black"
    document.getElementById("third").style.backgroundColor="dodgerblue"
  ...
  {
    var firstitem=document.getElementById("four").innerHTML
    var table=document.createElement("table");
    var newbody=document.createElement("tbody")
    newbody.setAttribute("id","newvalue")
    for(var i=(((+firstitem)-1)*5);i<=(((+firstitem)-1)*5)+4;i++)
    ...
    document.getElementById("third").style.backgroundColor="transparent"
    document.getElementById("third").style.color="black"
    document.getElementById("four").style.backgroundColor="dodgerblue"
  ...
  else if(this.id==="five")
  {
    ...
    var firstitem=document.getElementById("five").innerHTML
    var table=document.createElement("table");
    var newbody=document.createElement("tbody")
    newbody.setAttribute("id","newvalue")
    for(var i=(((+firstitem)-1)*5);i<=(((+firstitem)-1)*5)+4;i++)
    ...
    document.getElementById("four").style.backgroundColor="transparent"
    document.getElementById("four").style.color="black"
    document.getElementById("five").style.backgroundColor="dodgerblue"
